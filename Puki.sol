...
contract Puki is ERC20, Ownable {
    ...
    string private constant _name = "Puki";
    string private constant _symbol = "PUKI";

    uint256 public initialTotalSupply = 10_000_000_000 * 1e18;
    uint256 public maxTransactionAmount = initialTotalSupply / 10000;
    uint256 public maxWallet = initialTotalSupply / 10000;
                   ...
                   if(blockNum > (blockStart + blockSnipe))
                    {
                      ...
                      maxTransactionAmount = initialTotalSupply / 20000;
                      maxWallet = initialTotalSupply / 10000;
                    }
